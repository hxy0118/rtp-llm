...
def exit_graph_capture_mode() -> None:
    ...
    # Notify TRT-LLM AllReduce Fusion to finalize IPC pointers after graph capture
    try:
        from rtp_llm.models_py.distributed.trt_allreduce import consume_capture
        consume_capture()
    except ImportError:
        pass
    except Exception as e:
        logging.warning(f"Failed to call trtllm consume_capture: {e}")
